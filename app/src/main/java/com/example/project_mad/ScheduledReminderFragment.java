...
public class ScheduledReminderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_scheduled_reminder, container, false);

        recyclerView = rootView.findViewById(R.id.scheduledReminderRecyclerView);
    ...
    public static class Reminder {
        ...
        private String scheduleTime; // New field for scheduled time
    ...
    public class ReminderAdapter extends RecyclerView.Adapter<ReminderAdapter.ReminderViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ReminderViewHolder holder, int position) {
            ...
            holder.checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                String newStatus = isChecked ? "completed" : "scheduled";
        ...
        public class ReminderViewHolder extends RecyclerView.ViewHolder {
            public TextView reminderTitle, reminderDescription, reminderScheduleTime;
    ...
    private void loadScheduledReminders() {
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        remindersRef.orderByChild("status").equalTo("scheduled")
